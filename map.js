...
async function geocodeAndDrawRoute() {
    ...
    try {
        ...
        const warningMsg = stillDangerous
            ...
            : (redZones.length > 0 ? ' Route adjusted to avoid danger zones!' : '');
...
function printDirections() {
    ...
    printHTML += `
            ...
            <div class="footer">
                ...
                <p>Always check current road conditions and follow local traffic laws</p>
...
function downloadDirections() {
    ...
    content += `Always check current road conditions and follow local traffic laws\n`;
